...
def load_existing_lines(output_file):
    """
    Load existing lines from the output file into a dict keyed by field 8.
    Returns:
        lines_dict: {process_name: original_line}
        ordered_keys: list of process names in file order
    """
    lines_dict = {}
    ordered_keys = []
...
def process_input(input_file, output_file):
    lines_dict, ordered_keys = load_existing_lines(output_file)
